package com.aeternal.tiabs.client.render;

import java.awt.Color;

import com.aeternal.tiabs.client.render.magiccircles.IColorFunction;
import com.aeternal.tiabs.entities.EntityTimeAccelerator;
import com.aeternal.tiabs.client.render.magiccircles.ColorFunctions;
import com.aeternal.tiabs.handler.RTEventHandler;
import com.aeternal.tiabs.util.client.RenderUtils;
import com.aeternal.tiabs.util.client.MKRRenderUtil;
        ...
        for (EnumFacing facing : EnumFacing.VALUES)
        {
            ...
            if (timeRate >= 32) {
                MKRRenderUtil.renderCircleDecTriPart5Tri(0.16, 0.15, (i) -> {
                    float hue = (float) (i + progress) / 100.0f; // Change the divisor to adjust rainbow speed
